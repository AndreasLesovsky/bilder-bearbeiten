...
if (count($_POST) > 0) {
        ...
        if (in_array($uploadedImage['type'], $whitelist)) {
            ...
            if ($image) {
                ...
                if ($croppedImage !== FALSE) {
                    ...
                    $msg .= "<p class='col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6'><strong>Zugeschnittenes Bild:</strong></p>
                            <img src='$croppedPath' alt='Zugeschnittenes Bild' class='col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6' id='cropped-image'>
                            <p class='success col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6'>Das Bild wurde erfolgreich zugeschnitten und gespeichert! Sie können es herunterladen.</p>
                            <a href='$croppedPath' download class='link-btn'>Bild herunterladen</a>";
                } else {
                    $msg .= "<p class='error col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6'>Bild konnte nicht zugeschnitten werden. Bitte geben Sie gültige Werte ein, die innerhalb der zulässigen Grenzen sind.</p>";
                }

                imagedestroy($image);
            }
        } else {
            $msg = "<p class='error col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6'>Ungültiges Dateiformat. Erlaubt sind nur JPEG, PNG, WebP, GIF und BMP Dateien.</p>";
        }
    }
    ...
    if (isset($_FILES['bildScale'])) {
        ...
        $msg .= "<p class='success col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6'>
...
<body>
    ...
    <main>
        ...
        <section id="content1" class="grid">
            <h2 class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">Zuschneiden</h2>
            <?php echo ($msg); ?>
            <form method="post" enctype="multipart/form-data" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6 grid">

                <div class="image-upload-container col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                ...
                <fieldset class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6 grid">
                    <legend class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        Werte für das Zuschneiden in Pixeln eingeben:
                    </legend>
                    <label class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-6">
                ...
                <input type="submit" value="zuschneiden" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
            </form>
        </section>

        <section id="content2" class="grid" style="display:none;">
            <h2 class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">Skalieren</h2>
            <?php echo ($msg); ?>
            <form method="POST" enctype="multipart/form-data" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6 grid">
                <div class="image-upload-container col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <div class="custom-file-upload">
                ...
                <input type="submit" value="skalieren" class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
            </form>
